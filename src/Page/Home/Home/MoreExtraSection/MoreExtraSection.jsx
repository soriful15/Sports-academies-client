...
import pic from '../../../../assets/section pic/pic 1.jpeg';
import pic2 from '../../../../assets/section pic/pic3.jpeg';
           ...
           <h1 className='text-2xl lg:text-4xl text-center font-bold text-slate-900 mt-9 dark:text-white'>OUR
            ...
            <div className='grid lg:grid-cols-2 container gap-7 mx-auto mt-4 lg:mt-10'>
                <div className=''>
                    ...
                    <p className='text-sm text-slate-700 font-normal text-center mt-3 dark:text-white'>Sport Academy  is a skills-based  program and course that will reshape the way kids learn and play</p>
