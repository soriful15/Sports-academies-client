...
const PopularInstructor = () => {
    ...
    return (
        <>
            ...
            <h1 className='text-2xl lg:text-4xl text-center font-bold text-slate-900 mt-9 dark:text-white'>Popular Instructors</h1>
            <p className='text-center container mx-auto text-lg mt-2 text-gray-500 dark:text-white'>A popular sport instructor is a skilled and experienced professional who specializes in teaching and coaching a specific sport <br /> to individuals or groups. They possess in-depth knowledge of the sport's rules, techniques, and strategies, and are passionate about sharing their expertise with other</p>
            <div className='grid lg:grid-cols-3 md:grid-cols-2 container mx-auto mt-10 gap-10 w-full'>
                {
                    instructorClasses.map((user) => <div key={user._id} className='relative  rounded shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 duration-200 w-full lg:w-96'>
